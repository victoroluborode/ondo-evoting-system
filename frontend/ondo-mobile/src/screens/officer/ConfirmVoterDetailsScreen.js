...
export default function ConfirmVoterDetailsScreen({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={[typography.h1, styles.title]}>Confirm Details</Text>
        ...
        <View style={styles.readonlyCard}>
          ...
          <View style={styles.readonlyRow}>
            <Text style={styles.readonlyLabel}>Constituency</Text>
            <Text style={styles.readonlyValue}>
              {getConstituencyName(voterData.constituencyId) ||
                voterData.constituencyId}
            </Text>
          </View>

          <View style={[styles.readonlyRow, styles.readonlyRowLast]}>
            <Text style={styles.readonlyLabel}>LGA</Text>
            <Text style={styles.readonlyValue}>
              {getLgaName(voterData.constituencyId, voterData.lgaId) ||
                voterData.lgaId}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.notice}>
          <Text style={styles.noticeText}>
            At least one of email or phone is recommended so the voter can reset
