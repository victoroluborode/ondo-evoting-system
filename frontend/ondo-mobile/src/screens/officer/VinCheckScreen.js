...
export default function VinCheckScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={[typography.h1, styles.title]}>Check Voter ID</Text>
        <Text style={[typography.subtitle, styles.subtitle]}>
          Enter the voter's VIN to look them up in the official register.
        </Text>
