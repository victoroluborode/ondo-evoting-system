...
-- Table 4: Election Administrators
...
-- Table 5: Voters (PARTITIONED by constituency_id)
CREATE TABLE voters (
...
-- Table 6: Candidates (PARTITIONED by constituency_id)
...
-- Table 7: Votes (PARTITIONED by constituency_id)
CREATE TABLE votes (
    id UUID DEFAULT uuid_generate_v4(),
...
-- Table 8: Results (aggregated vote counts)
...
-- Table 9: Auth sessions used to invalidate short-lived partial and voting tokens
...
-- Table 10: Password reset tokens, stored hashed to protect reset links at rest
